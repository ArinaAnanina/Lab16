...
namespace Lab16_Базы_данных_
{
    partial class Form5
    {
        ...
        private static List<string> GetCustomer()
        {
            var context = new tempdbEntities();
            var query = from o in context.Customers
                        select o.Id + " " + o.Name + o.Surname;
            var customers = query.ToList();
            return customers;
        }
        public string GetCurrentCustomer(int idCustomer)
        {
            List<string> customers = GetCustomer();
            foreach (string s in customers)
            {
                if (s.Contains(idCustomer.ToString()))
                {
                    return s;
                }
            }
        ...
        public void ShowChange(Order order)
        {
            this.Text = "CHANGE";
            this.label1.Text = "Изменение элемента";
            this.button1.Text = "Изменить";
            this.textBox1.Text = order.Id.ToString();
            this.textBox1.ReadOnly = true;
            this.comboBox1.DataSource = GetCustomer();
            this.comboBox1.Text = GetCurrentCustomer(order.IdCustomer);
            this.dateTimePicker1.Value = order.OrderDate;
            this.textBox4.Text = order.TrackNumber.ToString();
            Show();
        }
        public void ShowAdd(int orderId)
        {
            this.textBox1.Text = (orderId + 1).ToString();
            this.comboBox1.DataSource = GetCustomer();
            Show();
        }
        ...
        private void InitializeComponent()
        {
            ...
            // textBox4
            // 
            this.textBox4.Location = new System.Drawing.Point(27, 276);
            ...
            this.label5.Text = "Введите трек номер";
            // 
            // label4
            // 
            ...
            this.label3.Text = "Введите покупателя";
            // 
            // label2
            // 
